      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center reveal-bottom">
          <div className="relative">
            <span className="text-6xl absolute -left-8  -top-2 text-white opacity-30 select-none">"</span>
            <p className="text-2xl md:text-3xl font-serif italic mb-8 pt-6 leading-relaxed">
            ...
            <span className="text-6xl absolute right-25 -bottom-14 text-white opacity-30 select-none">"</span>
          </div>
