...
export default function Hero() {
  return (
    <section className="pt-32 pb-20 md:pt-40 md:pb-32 bg-white" id="hero">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mb-10 md:mb-0 reveal-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-gray-900 leading-tight mb-6">
              Szakértő jogi <br />
              képviselet <span className="text-yellow-900">minden</span> helyzetben
            </h1>
  ...
  onClick={(e) => {
    e.preventDefault();
    customScrollTo("kapcsolat", 1000); // 1000 ms = 1 másodperces scroll animáció
  }}
...
>
  Időpontfoglalás
          ...
          {/* Jobb oldal: kép */}
          <div className="md:w-1/2 flex justify-center reveal-right" style={{ animationDelay: "0.3s" }}>
